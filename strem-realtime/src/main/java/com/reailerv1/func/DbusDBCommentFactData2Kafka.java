...
import com.stream.util.DateTimeUtils;
import com.stream.util.KafkaUtils;
import com.stream.util.SensitiveWordsUtils;
...
public class DbusDBCommentFactData2Kafka {
    ...
    @SneakyThrows
    public static <DataStream> void main(String[] args) {
        ...
        org.apache.flink.streaming.api.datastream.DataStream<JSONObject> filteredOrderInfoStream = kafkaCdcDbSource
        ...
        org.apache.flink.streaming.api.datastream.DataStream<JSONObject> filteredStream = kafkaCdcDbSource
                .map(JSON::parseObject)
        ...
        org.apache.flink.streaming.api.datastream.DataStream<JSONObject> enrichedStream = AsyncDataStream
                .unorderedWait(
                        filteredStream,
