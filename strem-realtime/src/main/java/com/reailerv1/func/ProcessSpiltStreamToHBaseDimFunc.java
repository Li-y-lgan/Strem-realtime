...
/**
 * @Package com.reailerv1.func.ProcessSpiltStreamToHBaseDimFunc
 * @Author li.yan
 * @Date 2025/5/13 16:30
 * @description:
 */
import com.reailerv1.domain.TableProcessDim;
import com.stream.util.ConfigUtils;
import com.stream.util.HbaseUtils;
import com.stream.util.JdbcUtils;
