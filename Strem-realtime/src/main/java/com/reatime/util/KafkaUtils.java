...
public final class KafkaUtils {
    ...
    public static Properties buildPropsStringDeserializer(String groupId) {
        ...
        props.setProperty("bootstrap.servers", com.reatime.util.ConfigUtils.getString("bootstrap.servers"));
        System.err.println(com.reatime.util.ConfigUtils.getString("bootstrap.servers"));
    ...
    public static Properties buildPropsByProducer() {
        final Properties props = new Properties();
        props.setProperty(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, com.reatime.util.ConfigUtils.getString("kafka.bootstrap.servers"));
